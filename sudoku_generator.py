...
class SudokuGenerator:
    ...
    def __init__(self, row_length, removed_cells):
        ...
        self.board = [[0 for i in range(self.row_length)] for j in
                      range(self.row_length)]  # Using 0 to mean there is no value placed
    ...
    def is_valid(self, row, col, num):
        ...
        row_start = (row // 3) * 3
        col_start = (col // 3) * 3
        return self.valid_in_col(col, num) and self.valid_in_row(row, num) and self.valid_in_box(row_start, col_start,
                                                                                                 num)
